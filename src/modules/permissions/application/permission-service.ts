...
import { basicPolicy, permissionChangeSchema, principalId, subjectKey, type PermissionChange, type PermissionPolicy, type PermissionSnapshot, type PermissionSubject, type ToolOperation } from "../domain/permissions.js";
import type { PermissionLifetime, PermissionRepository, PermissionRequest } from "../ports/permission-repository.js";
