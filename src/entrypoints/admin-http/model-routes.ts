...
import type { AuthManagement } from "../../modules/models/index.js";
...
export class ModelRoutes {
  ...
  public constructor(private readonly models: ModelManagement, private readonly auth: AuthManagement,
