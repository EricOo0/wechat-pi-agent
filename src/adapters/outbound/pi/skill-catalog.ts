...
import { DefaultPackageManager, loadSkills, stripFrontmatter, type SettingsManager, type Skill, type ResolvedResource } from "@earendil-works/pi-coding-agent";
import type { AgentEvent } from "../../../domain/execution/step.js";

/** Preserve Pi ordering, inserting bundled skills after explicit project paths. */
export function skillPathsWithBundled(resources: ResolvedResource[], bundled: string): string[] {
