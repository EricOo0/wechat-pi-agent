...
| H-001 | [通用 Task 执行与控制](agent-harness/spec.md) | feature | experimental | implemented | planned | R-001, M-001 | H-002 |
...
| R-001 | [系统模块化与工作流重构](system-refactor/spec.md) | feature | stable | implemented | planned | — | H-001 |
